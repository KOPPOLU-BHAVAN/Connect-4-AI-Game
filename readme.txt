...
This project is a Pygame application that provides an interface to choose and run different Python scripts. The key feature is the AI algorithm implemented using Alpha-Beta Pruning for one of the game options.
